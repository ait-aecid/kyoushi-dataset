...
The Logstash pipeline configuration used to configure the processing mode and options. This is generated by the Logstash setup processor and the config is
